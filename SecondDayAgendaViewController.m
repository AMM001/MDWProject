...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([[[_secondDaySessions objectAtIndex:indexPath.row] sessionType] isEqualToString:@"Session"]){
        imageView.image=[UIImage imageNamed:@"session.png"];
    }else if([[[_secondDaySessions objectAtIndex:indexPath.row] sessionType] isEqualToString:@"Workshop"]){
        imageView.image=[UIImage imageNamed:@"workshop.png"];
    }else if([[[_secondDaySessions objectAtIndex:indexPath.row] sessionType] isEqualToString:@"Break"]){
        imageView.image=[UIImage imageNamed:@"breakicon.png"];
    }
    else if([[[_secondDaySessions objectAtIndex:indexPath.row] sessionType] isEqualToString:@"Hackathon"]){
